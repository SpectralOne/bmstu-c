...
void test_da_reallocate_array(void)
{
    printf("\n--- %s ---\n\n", __func__);
    int err_count = 0;
...
/*
    printf("Realloc with negative size: ");
    {
        ...
        status = da_reallocate_array(&test_array, &end_array, -3);
...
//        status = da_reallocate_array(&test_array, &end_array, 0, 3276799999);
...
void test_da_normalize_array(void)
{
    printf("\n--- %s ---\n\n", __func__);
    int err_count = 0;
...
void test_da_insert_to_pos(void)
{
    printf("\n--- %s ---\n\n", __func__);
    int err_count = 0;
...
int main(void)
{
    ...
    test_move_to_end();
    test_f_equal();
    test_da_reallocate_array();
    test_da_normalize_array();
    test_da_insert_to_pos();
}
