...
/**
 * @brief Функция сброса сортировки. Убирает флаг.
 * 
 */
 ...
 * @brief Cортировкa
 */
static void Sort(uiButton *b, void *data)
{
    if (main_arr)
    {    
        if (rb_changed)
        ...
        {   
            ...
            {
            case 1:
                sort_arr(main_arr, main_array_size, &compare_sex);
                break;
            case 2:
                sort_arr(main_arr, main_array_size, &compare_birth_date);
                break;
            case 3:
                sort_arr(main_arr, main_array_size, &compare_grade_average);
                break;
            default:
                sort_arr(main_arr, main_array_size, &compare_surname);
                break;
            }
